...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email="other@example.com", password="otherpass1234")
    ...
    def test_partial_update(self):
        ...
        recipe = create_recipe(user=self.user, title='Sample recipe title', link=orginal_link)
    ...
    def test_full_update(self):
        """Testing full update for a recipe"""
    ...
    def test_update_recipe_assing_ingredient(self):
        """Test assigning an existing ingredient tag when updating a recipe."""
        ingredient = Ingredient.objects.create(user=self.user, name='Lime')
        recipe = create_recipe(user=self.user)

        recipe.ingredients.add(ingredient)
        new_ingredient = Ingredient.objects.create(user=self.user, name='Garlic')
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title="Roasted Duck")
